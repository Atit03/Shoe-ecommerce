        ...
        <div className="wrapper w-5/6 sm:w-3/4 md:w-3/5 xl:w-2/5 container py-16 px-8 sm:px-12 bg-white relative">
          ...
          >
            ...
            <div className="agreement text-sm text-dark-grayish-blue py-4">
              Bằng việc tiếp tục bạn chấp nhận với  <b>Chính sách </b> của chúng tôi
            </div>
            <button
              className={
                "w-full h-12 max-w-lg lg:max-w-none bg-orange rounded-md mt-3 lg:mt-5 mb-2 text-white flex items-center justify-center lg:w-2/5 shadow-[inset_0_-1px_0_0_#ffede1] hover:shadow-[inset_0_-4rem_0_0_#ffede1] hover:text-orange border transition-all duration-300 cursor-pointer " +
